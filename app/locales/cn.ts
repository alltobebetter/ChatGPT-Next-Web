...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ? `🚀 **释放AI的终极力量！AIBoB：你的AI私人助理，现在就开启未来之旅！** 🚀

还在苦苦寻找稳定、强大、价格实惠的AI解决方案？你的搜索到此为止！AIBoB隆重登场，为你带来前所未有的AI体验！[立即输入你的专属通行证，开启AI之旅！](/#/auth)

🔥 **AIBoB，AI界的瑞士军刀，集所有尖端科技于一身！**

我们整合了市面上最炙手可热的AI模型巨头，包括但不限于：**Claude-3.5-Sonnet**（莎士比亚般的优雅与智慧）、**Gemini-1.5-Pro**（双子星般闪耀的性能）、以及传奇般的 **GPT-4o** 等。所有这些，只为一个目标：**赋予无限的创造力！**

✨ **AIBoB的超能力：**

* **无所不能的AI助手：**  写作、翻译、编程、创作故事、头脑风暴……只有你想不到，没有AIBoB做不到！
* **99.999% 超稳定运行：**  告别掉线和崩溃，尽情享受流畅的AI体验！比瑞士手表还精准！
* **价格屠夫：**  以难以置信的低价，即可拥有市面上最强大的AI工具！物超所值，绝对让你尖叫！
* **无限畅享，无拘无束：** 注册后即可解锁所有高级模型，无限制使用！释放你内心的AI野兽！
* **五星级售后服务：** 我们的客服团队24/7全天候待命，随时为你解答任何疑问！比你的私人管家还贴心！

还在犹豫什么？[没有密码？立即加入AIBoB，开启你的AI冒险之旅！](https://afdian.com/a/suaolin)  获取你的专属密码，见证奇迹的时刻！

💡 **遇到问题？** 别担心，我们为你准备了全面的[帮助文档](https://pages.aibob.top/help/)，随时为你排忧解难！

**AIBoB：AI的未来，现在就掌握在你手中！**`
      : `🚀 **释放AI的终极力量！AIBoB：你的AI私人助理，现在就开启未来之旅！** 🚀
